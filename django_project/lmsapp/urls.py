...
urlpatterns = [
    ...
    path('edit_drop_pick_zone/<int:drop_pick_zone_id>/', admin_views.edit_drop_pick_zone, name='edit_drop_pick_zone'),
    ...
    path('courier_tracking/', warehouse_views.courier_tracking, name='courier_tracking'),
