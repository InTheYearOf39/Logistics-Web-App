...
def notify_arrival(request, package_id):
    if request.method == 'POST':
        ...
        send_mail('Package Arrival Notification', sender_message, sender, [sender_email])
        ...
        send_mail('Package Arrival Notification', warehouse_message, sender, [warehouse_email])
