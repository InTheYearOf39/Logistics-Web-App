...
class Package(models.Model):
    ...
    # dropOffLocation = models.CharField(max_length=255, null=True, blank=True)  # Change to CharField
    # recipientPickUpLocation = models.CharField(max_length=255, null=True)
